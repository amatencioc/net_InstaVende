        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseSystemPrompt = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    EnableHandoff = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BotConfigs_Businesses_BusinessId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppSecretEncrypted = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChannelConfigs_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntentName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TriggerPhrases = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BotIntents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BotIntents_BotConfigs_BotConfigId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BotKnowledges_BotConfigs_BotConfigId",
                        column: x => x.BotConfigId,
                        principalTable: "BotConfigs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsEntryFlow = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConversationFlows_BotConfigs_BotConfigId",
                        column: x => x.BotConfigId,
                        principalTable: "BotConfigs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentByBot = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BotConfigs_BusinessId",
                table: "BotConfigs",
                column: "BusinessId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BotIntents_BotConfigId",
                table: "BotIntents",
                column: "BotConfigId");

            migrationBuilder.CreateIndex(
                name: "IX_BotKnowledges_BotConfigId",
                table: "BotKnowledges",
                column: "BotConfigId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelConfigs_BusinessId_ChannelType",
                table: "ChannelConfigs",
                columns: new[] { "BusinessId", "ChannelType" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Contacts_BusinessId_ChannelType_ExternalId",
                table: "Contacts",
                columns: new[] { "BusinessId", "ChannelType", "ExternalId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ConversationFlows_BotConfigId",
